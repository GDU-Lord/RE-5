...
В файле __*main.js*__ инициализируется движок, загружаются все скрипты из папки *Scripts*, создаются сцены, к сценам подключаются скрипты из папки *Scenes/название сцены*, осуществляется переход на нужную сцену.
...
В скрипте __*sources.js*__ загружаются все нужные текстуры.
