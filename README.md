...
### Family.forNearTo(pos, callback[, dist[, chunk_mode[, chunk_dist[, camera]]]])
...
- __camera__ `<boolean> ` __*Default:*__ `false` - режим учёта позиции камеры (для элементов интерфейса в качестве __pos__.
