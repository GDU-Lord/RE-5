...
Разработку можно вести из любого удобного вам текстового редактора или редактора кода, т.к. визуального редактора для движка пока что нет.
...
Вы можете самостоятельно создавать плагины или скачать их на нашем сайте (ссылка).
Чтобы поделиться своими наработками или сообщить о проблеме присоединяйтесь к нашему сообществу в Discord (ссылка).
